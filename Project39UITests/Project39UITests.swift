...
class Project39UITests: XCTestCase {
    ...
    func testInitialStateIsCorrect() {
        ...
        XCTAssertEqual(table.cells.count, 7, "There should be 7 rows initially") // because of the "swift" filter
    }
    
    // When recording, use Mac's keyboard to enter text;
    // After recording, can edit/simplify the generated text
    func testUserFilteringByString() {
        ...
        textField.typeText("test") // the filter text entered
